const ChannelDividend = artifacts.require('ChannelDividend');
...
var conf = {
    ...
    supervisor_address: '0x4cC4c344ebA849DC09ac9Af4bfF1977e44FC1D7E',
...
module.exports = function(deployer, network, accounts) {
    ...
    deployer.deploy(ChannelDividend, conf.ring_address, conf.supervisor_address, 42);
    deployer.deploy(Proxy).then(async() => {
        ...
        await registry.setAddressProperty(channelDivId, ChannelDividend.address);
